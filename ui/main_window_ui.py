...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tasks_in = QtWidgets.QLabel(self.widget_6)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.tasks_in.setFont(font)
        self.tasks_in.setObjectName("tasks_in")
        self.horizontalLayout_2.addWidget(self.tasks_in)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_btn.setToolTip(_translate("MainWindow", "Collapse menu (Alt+M)"))
        self.menu_btn.setShortcut(_translate("MainWindow", "Alt+M"))
        self.menu_btn.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        ...
        self.home_btn_1.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        self.tasks_btn_1.setToolTip(_translate("MainWindow", "Tasks (Alt+T)"))
        self.tasks_btn_1.setShortcut(_translate("MainWindow", "Alt+T"))
        self.tasks_btn_1.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        ...
        self.completed_tasks_btn_1.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        ...
        self.calendar_btn_1.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        self.exit_btn_1.setToolTip(_translate("MainWindow", "Exit (Alt+F4)"))
        self.exit_btn_1.setProperty("groupName", _translate("MainWindow", "nav_icon_buttons"))
        self.home_btn_2.setToolTip(_translate("MainWindow", "Home (Alt+H)"))
        self.home_btn_2.setText(_translate("MainWindow", "Home"))
        self.home_btn_2.setShortcut(_translate("MainWindow", "Alt+H"))
        self.home_btn_2.setProperty("groupName", _translate("MainWindow", "nav_buttons"))
        self.tasks_btn_2.setToolTip(_translate("MainWindow", "Tasks (Alt+T)"))
        self.tasks_btn_2.setText(_translate("MainWindow", "Tasks"))
        self.tasks_btn_2.setShortcut(_translate("MainWindow", "Alt+T"))
        self.tasks_btn_2.setProperty("groupName", _translate("MainWindow", "nav_buttons"))
        self.completed_tasks_btn_2.setToolTip(_translate("MainWindow", "Completed Tasks (Alt+C)"))
        ...
        self.completed_tasks_btn_2.setProperty("groupName", _translate("MainWindow", "nav_buttons"))
        self.calendar_btn_2.setToolTip(_translate("MainWindow", "Calendar (Alt+L)"))
        self.calendar_btn_2.setText(_translate("MainWindow", "Calendar"))
        self.calendar_btn_2.setShortcut(_translate("MainWindow", "Alt+L"))
        self.calendar_btn_2.setProperty("groupName", _translate("MainWindow", "nav_buttons"))
        self.exit_btn_2.setToolTip(_translate("MainWindow", "Exit (Alt+F4)"))
        self.exit_btn_2.setText(_translate("MainWindow", "Exit"))
        self.exit_btn_2.setProperty("groupName", _translate("MainWindow", "nav_buttons"))
        self.label_3.setText(_translate("MainWindow", "TASK MANAGEMENT SYSTEM"))
        self.search_btn.setToolTip(_translate("MainWindow", "Search for tasks (Alt+S)"))
        self.search_btn.setShortcut(_translate("MainWindow", "Alt+S"))
        self.search_btn.setProperty("groupName", _translate("MainWindow", "top_buttons"))
        self.user_btn.setToolTip(_translate("MainWindow", "Click to see user options (Alt+U)"))
        self.user_btn.setShortcut(_translate("MainWindow", "Alt+U"))
        ...
        self.add_project_btn.setToolTip(_translate("MainWindow", "Add new project (Alt+P)"))
        self.add_project_btn.setText(_translate("MainWindow", "Add Project"))
        self.add_project_btn.setShortcut(_translate("MainWindow", "Alt+P"))
        ...
        self.manage_project_btn.setShortcut(_translate("MainWindow", "Alt+N"))
        self.manage_project_btn.setProperty("groupName", _translate("MainWindow", "project_buttons"))
        self.tasks_in.setText(_translate("MainWindow", "Tasks in the Default Project:"))
        self.add_task_btn.setText(_translate("MainWindow", "Add Task"))
        self.add_task_btn.setShortcut(_translate("MainWindow", "Alt+A"))
