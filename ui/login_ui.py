...
class Ui_LogIn(object):
    def setupUi(self, LogIn):
        ...
        self.sign_up_btn.setMinimumSize(QtCore.QSize(0, 20))
        self.sign_up_btn.setFocusPolicy(QtCore.Qt.TabFocus)
    ...
    def retranslateUi(self, LogIn):
        ...
        self.sign_up_btn.setToolTip(_translate("LogIn", "Create a new account."))
