...
class Ui_LogIn(object):
    def setupUi(self, LogIn):
        ...
        self.login.setGeometry(QtCore.QRect(170, 160, 75, 23))
        self.login.setObjectName("login")
        self.sign_up = QtWidgets.QPushButton(self.centralwidget)
        self.sign_up.setGeometry(QtCore.QRect(40, 160, 75, 23))
    ...
    def retranslateUi(self, LogIn):
        ...
        self.username.setPlaceholderText(_translate("LogIn", "User Name"))
